...
{
    ubx_cfg_msg_std_nmea(STD_NMEA_ID_GGA, 1);
    ubx_cfg_msg_std_nmea(STD_NMEA_ID_GLL, 1);
    ubx_cfg_msg_std_nmea(STD_NMEA_ID_GSV, 1);
    ubx_cfg_msg_std_nmea(STD_NMEA_ID_VTG, 1);
}
