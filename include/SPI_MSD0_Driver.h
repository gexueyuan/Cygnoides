...
#define SD_CARD_SPI_CLK                   RCC_APB2Periph_SPI1

#define SD_CARD_SPI_SCK_PIN               GPIO_Pin_5                 /* PA.5 */
#define SD_CARD_SPI_SCK_GPIO_PORT         GPIOA                       /* GPIOA */
#define SD_CARD_SPI_SCK_GPIO_CLK          RCC_AHB1Periph_GPIOA
#define SD_CARD_SPI_SCK_SOURCE            GPIO_PinSource5
#define SD_CARD_SPI_SCK_AF                GPIO_AF_SPI1

#define SD_CARD_SPI_MISO_PIN              GPIO_Pin_6                 /* PA.6 */
#define SD_CARD_SPI_MISO_GPIO_PORT        GPIOA                       /* GPIOA */
#define SD_CARD_SPI_MISO_GPIO_CLK         RCC_AHB1Periph_GPIOA
#define SD_CARD_SPI_MISO_SOURCE           GPIO_PinSource6
#define SD_CARD_SPI_MISO_AF               GPIO_AF_SPI1

#define SD_CARD_SPI_MOSI_PIN              GPIO_Pin_7                 /* PA.7 */
#define SD_CARD_SPI_MOSI_GPIO_PORT        GPIOA                       /* GPIOA */
#define SD_CARD_SPI_MOSI_GPIO_CLK         RCC_AHB1Periph_GPIOA
#define SD_CARD_SPI_MOSI_SOURCE           GPIO_PinSource7
#define SD_CARD_SPI_MOSI_AF               GPIO_AF_SPI1

#define SD_CARD_SPI_CS_PIN                GPIO_Pin_4                 /* PC.5 */
#define SD_CARD_SPI_CS_GPIO_PORT          GPIOC                       /* GPIOC */
#define SD_CARD_SPI_CS_GPIO_CLK           RCC_AHB1Periph_GPIOC
//
///* Private define ------------------------------------------------------------*/
...
#define MSD0_card_enable()      	(GPIO_ResetBits(SD_CARD_SPI_CS_GPIO_PORT,SD_CARD_SPI_CS_PIN))
#define MSD0_card_disable()     	(GPIO_SetBits(SD_CARD_SPI_CS_GPIO_PORT,SD_CARD_SPI_CS_PIN))
