...
#define WIFI_USB_INIT_TIME_TICK     (200)   // 2s
typedef struct _wifi_usb_init_state {

    unsigned char check;
    unsigned char state;

    osal_task_t *usb_h;
    osal_timer_t *usb_check_timer;
}wifi_usb_init_state_t;

extern wifi_usb_init_state_t wifi_usb_init_check;
