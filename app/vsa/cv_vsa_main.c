...
static int ccw_add_list(VSA_APP_ID warning_id,vsa_position_node_t *p_pnt)
{
...
static int ccw_del_list(VSA_APP_ID warning_id,vsa_position_node_t *p_pnt)
{
